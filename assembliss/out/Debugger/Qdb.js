...
class AssemblissDebugSession extends DebugAdapter.LoggingDebugSession {
        ...
        switch (args.context) {
            ...
            default:
                if (args.expression.startsWith('$')) {
                    ...
                    rv = new Runtime_1.RuntimeVariable('eval', this.convertToRuntime(args.expression));
                }
                break;
        }
        if (rv) {
    ...
    convertFromRuntime(v) {
        ...
        if (v.name.indexOf('lazy') >= 0) {
            ...
            v.reference ?? (v.reference = this._variableHandles.create(new Runtime_1.RuntimeVariable('', [new Runtime_1.RuntimeVariable('', v.value)])));
